...
/**
 * Demonstraèní pøíklady pro alokaci, dealokaci a práci s jednorozmìrným
 * a dvourozmìrným polem.
 * Dále je v pøíkladu demonstrováno pøedávání pole jako parametru do funkce.
 * 
...
/**
 * Prostor jmen pro projekt Array and Pointers.
 */
namespace ArrayAndPointers
{
	/**
